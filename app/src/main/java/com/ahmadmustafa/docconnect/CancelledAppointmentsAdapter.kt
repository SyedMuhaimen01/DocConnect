...
class CancelledAppointmentsAdapter(private val appointments: List<bookAppointment.Appointment>) :
    RecyclerView.Adapter<CancelledAppointmentsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.cancelled_page_card, parent, false)
